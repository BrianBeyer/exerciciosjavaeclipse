...
//exemplo Scanner entrada = new Scanner(System.in);
		Produto p1 = new Produto("Laptop");//parametro sendo passado por causa do construtor
		//p1.nome = "Laptop";
		p1.preco = 4330.99;
		p1.desconto = 0.25;// para 25% de desconto

		var p2 = new Produto("Caneta");// var esta fazendo uma inferencia
		//p2.nome = "Caneta";
		p2.preco = 1.25;
		p2.desconto = 0.1;
		...
		Produto p3 = new Produto("Bambu", 50);
		//p3.nome = "Telemovel";
		//p3.preco = 2000;
		p3.desconto = 0.15;
